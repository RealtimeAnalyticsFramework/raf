...
class TpchQ6Action: public idgs::rdd::action::Action {
public:
  TpchQ6Action();
  virtual ~TpchQ6Action();

  TpchQ6Action(const TpchQ6Action& other) = delete;
  TpchQ6Action(TpchQ6Action&& other) = delete;
  TpchQ6Action& operator()(const TpchQ6Action& other) = delete;
  TpchQ6Action& operator()(TpchQ6Action&& other) = delete;
