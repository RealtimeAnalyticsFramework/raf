...
class DataMigraionListener: public idgs::cluster::PartitionListener {
public:

  DataMigraionListener();
  virtual ~DataMigraionListener();
...
class DataSyncListener: public idgs::cluster::MemberEventListener {
public:
  DataSyncListener();
  virtual ~DataSyncListener();
