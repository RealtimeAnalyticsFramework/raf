...
StoreConfig::StoreConfig() : keyTemplate(NULL), valueTemplate(NULL), partitioner(NULL) {
}
...
ResultCode StoreConfig::setStoreConfig(const ::idgs::store::pb::StoreConfig& storeConfig) {
  if (!keyTemplate) {
...
ResultCode StoreConfig::buildStoreListener() {
...
const ::idgs::store::pb::StoreConfig& StoreConfig::getStoreConfig() const {
  return storeConfig;
}

ResultCode StoreConfig::addListenerConfig(const pb::ListenerConfig& listenerConfig) {
...
const std::vector<StoreListener*>& StoreConfig::getStoreListener() const {
  return listeners;
}

void StoreConfig::addStoreListener(const StoreListener* listener) {
  listeners.push_back(const_cast<StoreListener*>(listener));
}

void StoreConfig::setMessageTemplate(const google::protobuf::Message* key, const google::protobuf::Message* value) {
  keyTemplate = const_cast<google::protobuf::Message*>(key);
  valueTemplate = const_cast<google::protobuf::Message*>(value);
}

ResultCode StoreConfig::parseKey(const protobuf::SerdesMode& mode, const std::string& buff, std::shared_ptr<google::protobuf::Message>& message) {
...
ResultCode StoreConfig::parseValue(const protobuf::SerdesMode& mode, const std::string& buff, std::shared_ptr<google::protobuf::Message>& message) {
...
std::shared_ptr<google::protobuf::Message> StoreConfig::newKey() {
  std::shared_ptr<google::protobuf::Message> message;
  message.reset(keyTemplate->New());
  return message;
}

std::shared_ptr<google::protobuf::Message> StoreConfig::newValue() {
  std::shared_ptr<google::protobuf::Message> message;
  message.reset(valueTemplate->New());
  return message;
}

const google::protobuf::Message* StoreConfig::getKeyTemplate() const {
  return keyTemplate;
}

const google::protobuf::Message* StoreConfig::getValueTemplate() const {
  return valueTemplate;
}

void StoreConfig::setSchema(const std::string& schemaName) {
  schema = schemaName;
}

const std::string& StoreConfig::getSchema() const {
  return schema;
}

ResultCode StoreConfig::calculatePartitionInfo(const std::shared_ptr<google::protobuf::Message>& key, StoreOption* ps) {
  size_t hash;
  if(unlikely(!ps)) {
    return RC_ERROR;
  }
