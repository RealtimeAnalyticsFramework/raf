...
public:
  ...
  CollectAction(const CollectAction& other) = delete;
  CollectAction(CollectAction&& other) = delete;
  CollectAction& operator()(const CollectAction& other) = delete;
  CollectAction& operator()(CollectAction&& other) = delete;
