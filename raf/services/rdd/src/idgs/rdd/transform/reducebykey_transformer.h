...
class ReduceByKeyTransformer: public Transformer {
public:
  ReduceByKeyTransformer();
  ~ReduceByKeyTransformer();

  virtual const std::string& getName() override {
    return REDUCEVALUE_TRANSFORMER;
  }
...
private:
  ...
  /// handle result
  void handleReduceResult(std::vector<reduce::ReduceOperation*>& operations, const idgs::actor::PbMessagePtr& key,
