...
public class SsbQ3_4IT extends TestCase {
  
  public void testSSBQ3_4() {
    ...
    sql.append("  SELECT c.c_city,\n")
       ...
       .append("         AND d.d_yearmonth = 'May1992'\n")
    ...
    System.out.println("========================= run SSB Q3.4 =========================");
    ...
    try {
      ...
      File file = new File("Q3.4.txt");
      FileOutputStream fos = new FileOutputStream(file);
      fos.write(("Q3.4 " + new DecimalFormat("0.00").format(time)).getBytes());
      fos.close();
