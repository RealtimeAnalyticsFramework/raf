...
;(function($, window, document, undefined) {
	...
	Tree.defaults = {
		...
		nodeExpandIcon: 'glyphicon fa fa-folder-o',
		nodeCollapseIcon: 'glyphicon fa fa-folder-open-o',
	...
	Tree.prototype = {
		...
		_buildTree: function(nodes, level) {
			...
			$.each(nodes, function addNodes(id, node) {
                ...
                var nodeIconClass = self.options.nodeExpandIcon;
				...
				if (node._nodes) {
                    ...
                    nodeIconClass = self.options.nodeCollapseIcon;
					treeItem
						.append($(self._template.iconWrapper)
							.append($(self._template.icon)
				...
				treeItem
					.append($(self._template.iconWrapper)
						.append($(self._template.icon)
							.addClass(node.icon ? node.icon : nodeIconClass))
					);
