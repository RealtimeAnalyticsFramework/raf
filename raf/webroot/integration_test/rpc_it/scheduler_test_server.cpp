...
const char start_work_operation_resp[] = "start_work_operation_succesfully";
const char sending_response_timeout[] = "sending_response_timeout";
const char sending_reponse_succ[] = "sending_reponse_successfully";
const char waiting_new_message_timeout[] = "waiting_new_message_timeout";
