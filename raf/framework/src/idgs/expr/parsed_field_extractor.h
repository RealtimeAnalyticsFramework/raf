...
class ParsedFieldExtractor: public NullaryExpression, public idgs::util::CloneEnabler<ParsedFieldExtractor, Expression> {
public:

  /// @brief Constructor
  ParsedFieldExtractor();

  /// @brief Destructor
  virtual ~ParsedFieldExtractor();
