...
public:
   ...
   * @param mt membership table
   * @param pt partition table
   * @param join/leave member
   * @param created delta partition event
   */
  virtual void balance(MembershipTable& members, PartitionTable& partitions, MemberWrapper& member, pb::DeltaPartitionEvent& evt) = 0;
