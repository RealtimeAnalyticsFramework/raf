    ...
    namespace tcp_test {
      ...
      int client_run() {
        ...
        try {
          ...
          std::shared_ptr<idgs::client::TcpClientInterface> client = ::idgs::util::singleton<idgs::client::TcpClientPool>::getInstance().getTcpClient(code);
          ...
          LOG(INFO) << " Get client to Server " << client->getServerAddress().DebugString();
