...
namespace idgs {
namespace client {
class TcpSynchronousClient: public TcpClient {
  friend class TcpClientPool;
public:

  TcpSynchronousClient(const idgs::client::pb::Endpoint& _server);

  TcpSynchronousClient(const TcpSynchronousClient&) = default;

  TcpSynchronousClient(TcpSynchronousClient&&) = default;
