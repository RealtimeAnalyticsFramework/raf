...
public class SsbQ2_3IT extends TestCase {
  
  public void testSSBQ2_3() {
    ...
    sql.append("  SELECT sum(lo.lo_revenue) lo_revenue,\n")
       ...
       .append("  WHERE  p.p_brand = 'MFGR#2238'\n")
       .append("         AND s.s_region = 'EUROPE'\n")
       .append("  GROUP  BY d.d_year,\n")
       .append("            p.p_brand\n")
       .append("  ORDER  BY d_year,\n")
       .append("            p_brand\n");
    
    System.out.println("========================= run SSB Q2.3 =========================");
    ...
    try {
      ...
      File file = new File("Q2.3.txt");
      FileOutputStream fos = new FileOutputStream(file);
      fos.write(("Q2.3 " + new DecimalFormat("0.00").format(time)).getBytes());
      fos.close();
