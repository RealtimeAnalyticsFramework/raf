...
public class SsbQ2_2IT extends TestCase {
  
  public void testSSBQ2_2() {
    ...
    System.out.println("========================= run SSB Q2.2 =========================");
    ...
    try {
      ...
      File file = new File("Q2.2.txt");
      FileOutputStream fos = new FileOutputStream(file);
      fos.write(("Q2.2 " + new DecimalFormat("0.00").format(time)).getBytes());
      fos.close();
      ...
      if (SsbTable.checkRawResult) {
        ...
        for (int row = 0; row < part.getRowCount(); ++ row) {
          ...
          if (p_brand.compareTo("MFGR#2221") >= 0 && p_brand.compareTo("MFGR#2228") <= 0) {
