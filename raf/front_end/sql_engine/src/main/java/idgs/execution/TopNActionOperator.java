...
import idgs.rdd.pb.PbRddAction.FieldPair.Builder;
...
public class TopNActionOperator extends ActionOperator {
  ...
  public void setLimit(long limit) {
    builder.setTopN(limit);
  }
  
  public void addOrderField(FieldNamePair field, boolean desc) {
    Builder orderField = builder.addOrderFieldBuilder();
  ...
  protected void buildRequest() {
    super.buildRequest();
    TopNActionRequest request = builder.build();
