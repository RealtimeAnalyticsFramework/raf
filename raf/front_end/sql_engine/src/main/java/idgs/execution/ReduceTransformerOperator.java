...
import idgs.rdd.pb.PbRddTransform.ReduceType;
import idgs.util.ServerConst;

public class ReduceTransformerOperator extends TransformerOperator {

  private ReduceByKeyRequest.Builder builder;
  
  public ReduceTransformerOperator() {
    super(ServerConst.REDUCE_TRANSFORMER);
    builder = ReduceByKeyRequest.newBuilder();
  }
  
  protected String getName() {
    return ServerConst.REDUCE;
  }
  ...
  public void addReduceField(String fieldAlias, String type, boolean distinct) {
    ...
    field.setType(ReduceType.valueOf(type.toUpperCase()));
